...
type PolicyReportInterface interface {
	Create(ctx context.Context, policyReport *v1beta2.PolicyReport, opts v1.CreateOptions) (*v1beta2.PolicyReport, error)
	Update(ctx context.Context, policyReport *v1beta2.PolicyReport, opts v1.UpdateOptions) (*v1beta2.PolicyReport, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.PolicyReport, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.PolicyReportList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.PolicyReport, err error)
...
func newPolicyReports(c *ReportsV1beta2Client, namespace string) *policyReports {
...
func (c *policyReports) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.PolicyReport, err error) {
	result = &v1beta2.PolicyReport{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *policyReports) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.PolicyReportList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.PolicyReportList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policyreports").
...
func (c *policyReports) Create(ctx context.Context, policyReport *v1beta2.PolicyReport, opts v1.CreateOptions) (result *v1beta2.PolicyReport, err error) {
	result = &v1beta2.PolicyReport{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policyreports").
...
func (c *policyReports) Update(ctx context.Context, policyReport *v1beta2.PolicyReport, opts v1.UpdateOptions) (result *v1beta2.PolicyReport, err error) {
	result = &v1beta2.PolicyReport{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policyreports").
...
func (c *policyReports) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.PolicyReport, err error) {
	result = &v1beta2.PolicyReport{}

...
import (
	...
	scheme "github.com/kubernetes-sigs/wg-policy-prototypes/policy-report/pkg/client/clientset/versioned/scheme"
...
type ClusterPolicyReportInterface interface {
	Create(ctx context.Context, clusterPolicyReport *v1beta2.ClusterPolicyReport, opts v1.CreateOptions) (*v1beta2.ClusterPolicyReport, error)
	Update(ctx context.Context, clusterPolicyReport *v1beta2.ClusterPolicyReport, opts v1.UpdateOptions) (*v1beta2.ClusterPolicyReport, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.ClusterPolicyReport, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.ClusterPolicyReportList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.ClusterPolicyReport, err error)
...
func newClusterPolicyReports(c *ReportsV1beta2Client) *clusterPolicyReports {
...
func (c *clusterPolicyReports) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.ClusterPolicyReport, err error) {
	result = &v1beta2.ClusterPolicyReport{}
	err = c.client.Get().
...
func (c *clusterPolicyReports) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.ClusterPolicyReportList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.ClusterPolicyReportList{}
	err = c.client.Get().
		Resource("clusterpolicyreports").
...
func (c *clusterPolicyReports) Create(ctx context.Context, clusterPolicyReport *v1beta2.ClusterPolicyReport, opts v1.CreateOptions) (result *v1beta2.ClusterPolicyReport, err error) {
	result = &v1beta2.ClusterPolicyReport{}
	err = c.client.Post().
		Resource("clusterpolicyreports").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterPolicyReports) Update(ctx context.Context, clusterPolicyReport *v1beta2.ClusterPolicyReport, opts v1.UpdateOptions) (result *v1beta2.ClusterPolicyReport, err error) {
	result = &v1beta2.ClusterPolicyReport{}
	err = c.client.Put().
		Resource("clusterpolicyreports").
...
func (c *clusterPolicyReports) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.ClusterPolicyReport, err error) {
	result = &v1beta2.ClusterPolicyReport{}

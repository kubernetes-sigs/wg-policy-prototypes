...
import (
	...
	v1beta1 "github.com/kubernetes-sigs/wg-policy-prototypes/policy-report/pkg/client/listers/wgpolicyk8s.io/v1beta1"
	v1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	runtime "k8s.io/apimachinery/pkg/runtime"
	watch "k8s.io/apimachinery/pkg/watch"
	cache "k8s.io/client-go/tools/cache"
	wgpolicyk8siov1beta1 "sigs.k8s.io/wg-policy-prototypes/policy-report/api/wgpolicyk8s.io/v1beta1"
)
